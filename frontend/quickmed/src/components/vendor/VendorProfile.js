...
const VendorProfile = ({
  ...
  const toggleOnlineStatus = () => {
    ...
    setLastSeen(new Date());
    console.log(
      `Vendor status changed to: ${newStatus ? "Online" : "Offline"}`
    );
  };
  ...
  const styles = {
    ...
    profileHeader: {
      padding: "30px",
      backgroundColor: isProfileComplete ? "#009688" : "#9CA3AF",
      color: "#FFFFFF",
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between",
    ...
    <div style={styles.mainContent}>
      ...
      <div style={styles.profileContainer}>
        <div style={styles.profileCard}>
          ...
          {!isProfileComplete && (
            <div style={styles.incompleteBadge}>⚠️ Profile Incomplete</div>
          )}
              ...
              <div style={styles.profileBasicInfo}>
                ...
                <div style={styles.profileStatus}>
                  <button
                    ...
                    title={
                      isProfileComplete
                        ? `Click to go ${isOnline ? "offline" : "online"}`
          ...
          <div style={styles.profileContent}>
            ...
            {!isProfileComplete && (
              <div style={styles.completionWarning}>
                ...
                <p style={styles.warningText}>
                  Complete your profile details to start accepting orders and
                  unlock all features.
                </p>
              </div>
            )}
            ...
            <div style={styles.profileSection}>
              ...
              <div style={styles.profileInfoGrid}>
                ...
                <div style={styles.profileInfoItem}>
                  ...
                  <span style={styles.profileInfoValue}>
                    {userProfile?.openingTime &&
                    userProfile.openingTime.trim() !== "" &&
                    userProfile?.closingTime &&
                    userProfile.closingTime.trim() !== ""
            ...
            {hasValidLegalData ? (
              ...
              <div style={styles.addDetailsSection}>
                <h3 style={styles.addDetailsTitle}>
                  Add Legal & Address Details
                </h3>
                <p style={styles.addDetailsText}>
                  Complete your legal and business information to start
