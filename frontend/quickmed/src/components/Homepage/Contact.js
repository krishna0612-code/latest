...
const Contact = () => {
  ...
  const styles = {
    ...
    contact: {
      minHeight: "100vh",
      background:
        "linear-gradient(135deg, #E0F2F1 0%, #FFFFFF 50%, #E0F2F1 100%)",
      position: "relative",
      overflow: "hidden",
      padding: isMobile ? "4rem 1rem" : isTablet ? "5rem 2rem" : "6rem 2rem",
    },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8000/api/save-contact/", {
        method: "POST",
        headers: {
      ...
      if (response.ok && result.status === "success") {
        ...
        alert("❌ Unable to submit request. Try again.");
      }
    } catch (err) {
            ...
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 15px 40px rgba(0, 150, 136, 0.2)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 8px 30px rgba(0, 150, 136, 0.1)";
              }}
            >
              <div style={styles.statNumber}>{stat.number}</div>
              <div style={styles.statLabel}>{stat.label}</div>
          ...
          <div style={styles.formSection}>
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = "translateY(-5px)";
                e.currentTarget.style.boxShadow =
                  "0 20px 50px rgba(0, 150, 136, 0.2)";
                e.currentTarget.style.borderColor = "#009688";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 15px 40px rgba(0, 150, 136, 0.15)";
                e.currentTarget.style.borderColor = "transparent";
              }}
            >
              <div style={styles.formHeader}>
